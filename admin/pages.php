...
<div class="container mt-5 mb-2">
	<div class="mt-2 border rounded p-3" style="background-color: #ffffff;color:#4E5269;">
	<?php
	  ...
	  echo "<script type='text/javascript'>alert('$message');</script>";
		...
		<h3 class="font-weight-light"><b>Carousel section</b></h3><hr/>
			...
			while($got_carousel = mysqli_fetch_assoc($view_for_carousel)){?>
				<form method="POST" enctype="multipart/form-data">
					<div class="row font-weight-bold">
						...
						<div class="col-md-3">
							<input id="profilePhotoIn" class="pull-left" type="file" name="product_Image" accept=".jpg, .jpeg, .png" required>
						</div>
