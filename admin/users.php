...
include_once 'includes/db_connect.php';
	...
	<?php
		if($count_got_results==0){
			...
			$message = "0 users found who are blocked!";
		}
		else{
			echo '<table class="mt-3 rounded table table-responsive" style="background-color: #ffffff;color:#4E5269;width:700px">
		  <thead class="thead-light px-2 mx-0">
			<tr>
			  <th scope="col">Id</th>
