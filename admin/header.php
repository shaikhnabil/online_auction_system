...
<html lang="en">
  <head>
	...
	<body>
		<nav class="navbar navbar-expand-lg" style="background-color:#ffffff !important; color:#4E5269;">
		   <a class="navbar-brand" href="index.php">
			   <img src="../img/logo.jpg" height="50px" width="150px" class="img-fluid" alt="logo">
		  ...
		  <div class="collapse navbar-collapse" id="navbarNav">
			...
			<ul class="navbar-nav">
			  ...
			  <div class="btn-group mb-1">
				  ...
				  <button type="button" class="text-dark btn btn-link dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
