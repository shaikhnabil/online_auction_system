...
?>
	<nav class="navbar navbar-dark text-right" style="background-color: #4E5269;color:#fff;">
	...
	<div class="container-fluid"> 
		...
		<div class="col-md-2 leftSide" id="left-bar" style="background-color: #4E5269;color:#fff;">
