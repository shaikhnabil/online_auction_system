...
?>
<div class="container-fluid mb-0 pb-5" style="background-color: #A8E0DA !important; color:#4E5269;">
	...
	<p><?php echo $_SESSION["emailloggedin"]?></p>
		<table class="table table-striped mb-5" style="background-color: #fff;">
		  <thead>
			<tr>
