	...
	<div class="row" style="background-color: #A8E0DA !important; color:#4E5269;">
		...
		<span aria-hidden="true">&times;</span>
					...
					<form method="POST" name="add_address">
						...
						<h5>Mobile Number </h5>
						<div class="form-group">
							<input type="text" class="form-control" name="mobileno" pattern="[0-9]{10}" maxlength="10" title="Enter valid number" id="exampleFormControlInput1" required>
						</div>
						<h5>Pincode</h5>
						<div class="form-group">
							<input type="text" class="form-control" name="pincode" pattern="^[1-9][0-9]{5}$" title="Enter 6 digit valid pincode" id="exampleFormControlInput1" required>
						</div>
