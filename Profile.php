...
?>
<div class="container-fluid mb-0 pb-5 py-5" style="background-color: #A8E0DA !important; color:#4E5269;">
	...
	<p><?php echo $_SESSION["emailloggedin"]?></p>
		<div class="text-center row">
			<div class="col-md-4">
				<div class="p-2 mt-4  rounded boxprofile" style="background-color: #fff;">
