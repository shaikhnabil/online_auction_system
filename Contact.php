...
<div class="container-fluid">
	...
	?>
	<div class="jumbotron jumbotron-fluid mb-0" style="background-color: #4E5269;">
	...
	<div class="container-fluid mt-1" style="background-color: #A8E0DA !important; color:#4E5269;">
		<div class="row">
			<div class="col-md-6 p-4">
				<div class="container-fluid rounded p-4" style="background-color: #fff">
					<h4>Contact us</h4>
					<hr/>
					<form method="POST">
						...
						<div class="form-group">
							...
							<select name="subject" class="form-control" id="exampleFormControlSelect2" required>
			...
			<div class="col-md-6 p-4">
				<div class="container-fluid rounded p-4 pb-5" style="background-color: #fff">
					...
					<div class="row">
						...
						<div class="col-md-10">
							<h5>Our Address</h5>
							<p>Bhavnagar-Ghogha circle, <br/>PO Ghogha circle, Bhavnagar<br/>364001, Gujarat</p>
					...
					<div class="row pb-5">
						...
						<div class="col-md-10 pb-5">
							<h5>Website</h5>
							<a class="simple_link" href="http://localhost/online_auction_system/">www.onlineauction.com</a>
							<hr/>
						</div>
					</div>						
