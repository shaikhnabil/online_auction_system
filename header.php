...
if (isset($_POST['signstep1'])) {
	if ($_POST['emailforsignup'] != "") {
		...
		if ($num_rows > 0) {
			...
			echo "<script type='text/javascript'>alert('Email already exists! Try another');</script>";
...
if (isset($_POST['loginbutton'])) {
	...
	if ($num_rows > 0) {
		...
		$error_msg_login = "Email does not exist!";
...
<body>
	<div class="container-fluid" style="background-color: #ffffff !important;">
		<div class="row border">
			<div class="mt-4 col-md-2 text-center border-right footer_list text-center">
				<a class="simple_link  mt-5" href="index.php"><img src="img/logo.jpg" height="50px" width="200px" class="img-fluid" alt="logo"></a>
						...
						<div class="row">
							...
							<div class="col-md-3 text-right">
								...
								if (isset($_SESSION['isloggedin'])) {
									echo '<a class="btn btn-outline-warning my-2 pb-2 mx-1 my-sm-0 text-dark" href="Cart.php"><i class="fas fa-shopping-cart mr-2 fa-lg"></i><span class="mr-2">Cart</span><span class="badge badge-secondary"></span></a>';
								}
								?>

								<a class="btn btn-outline-warning my-2 pb-2 my-sm-0 float-left" type="link" href="trending.php"><i class="fas fa-fire mr-sm-2 fa-lg"></i><span class="mr-sm-2">Trending</span></a>
							</div>
						</div>
					</div>
				</div>
