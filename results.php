...
<div class="container-fluid mb-0 mt-0" style="background-color: #A8E0DA !important; color:#4E5269;">
<div class="container">
	<?php
	...
	<?php echo '<h3 class="font-weight-light pt-2">' .$count. ' results found according to your search keyword."'.$var1.'"</h3><br/>';?>
