		...
		<div class="modal-dialog modal-lg modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLongTitle">Welcome to Online Auction System</h5>
								...
								<div class="col-md-6">
									<form name="login_form" method="POST">
										<div class="form-group">
											...
											<input type="email" name="userlogin" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email..." required>
										</div>
										<div class="form-group">
											<label for="exampleInputPassword1">Password</label>
											<input type="password" name="passlogin" class="form-control" id="exampleInputPassword1" placeholder="Password" required>
										</div>
						...
						<div class="tab-pane fade" id="signup" role="tabpanel" aria-labelledby="signup-tab">
							<div class="tab-content" id="myTabContent">
								<div class="tab-pane fade show active" id="step1" role="tabpanel" aria-labelledby="step1-tab">
									<div class="row p-3">
										<div class="col-sm-6">
											<div class="alert alert-info" role="alert" style="background-color: #fff;">
												<!-- <strong>Note: </strong> -->
												<!-- <p>After entering an email we will send you an OTP for account confirmation which is required.<br/> -->
												<img src="img/unlock-keyhole-solid.svg" width="300px" height="200px"/>
											</div>
										</div>
										<div class="col-sm-6">
											<form method="POST" name="signup1">
												...
												<button type="submit" name="signstep1" onclick="$('#st2-tab').trigger('click')" class="text-center btn btn-primary">Proceed <i class="fas fa-angle-right mr-3 fa-lg"></i></button>
											</form>
											<?php if (isset($script)) {
												echo $script;
											} ?>
