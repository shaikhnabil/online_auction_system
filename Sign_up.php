...
if (isset($_POST['pstep2'])) {
	...
	// if ($otpentered == $_POST['OTPentered']) {
	$pass1 = $_POST['pass1'];
	$pass2 = $_POST['pass2'];
	if ($pass1 != "" || $pass2 != "") {
		if ($pass2 == $pass1) {
			if (preg_match("#.*^(?=.{8,20})(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*\W).*$#", $pass1)) {
				...
				$m3 = "Your account has sussessfully been created! Login with your email id and password";
...
//unset($_SESSION['emailsignup']);
?>
<div class="container-fluid mt-2" style="background-color: #A8E0DA !important; color:#4E5269;">
	<?php
	if ($messagesignup != "" || $m1 != "" || $m2 != "" || $m3 != "" || $m4 != "") {
	...
	<div class="row text-center py-3">
		...
		<div class="col-md-6 border rounded p-4" style="background-color: #fff;">
			...
			<!-- <ul class="nav nav-tabs nav-fill mt-4" id="myTab" role="tablist">
				...
				<li class="nav-item">
					<a class="nav-link" id="st2-tab" data-toggle="tab" href="#st2" role="tab" aria-controls="st2" aria-selected="true">step 2</a>
				</li>
			</ul> -->
			...
			<form method="POST" name="otpcheck">
				<!-- <div class="form-group">
							...
							<input type="email" name="emaildisabled" class="form-control" id="exampleFormControlInput1" placeholder="<?php if (isset($_SESSION['emailsignup'])) {
																																			echo $emailsignup;
																																		} ?>" disabled />
						</div>
						<div class="form-group">
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<input type="password" name="pass1" class="form-control" id="exampleFormControlInput1" minlength="8" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required />
						</div>
					</div>
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" name="contact_no" class="form-control" id="exampleFormControlInput1" pattern="[0-9]{10}" maxlength="10" title="Enter valid number" required>
						</div>
						<div class="form-group">
							<label for="exampleFormControlInput1">Confirm Password</label>
							<input type="password" name="pass2" class="form-control" id="exampleFormControlInput1" required/>
						</div>
					</div>
				</div>
				<div class="form-group">
					<label for="exampleFormControlInput1">Address</label>
					<textarea type="text" name="address" class="form-control" id="exampleFormControlInput1" maxlength="40" required></textarea>
				</div>
				<div class="row">
					<div class="col-md-3">
						<label for="exampleFormControlSelect1">State</label>
						<select name="state" class="form-control" id="exampleFormControlSelect1" required>
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<input type="text" name="pincode" class="form-control" id="exampleFormControlInput1" pattern="^[1-9][0-9]{5}$" title="Enter 6 digit valid pincode" required />
						</div>
					</div>
					<div class="col-md-3">
				...
				<button name="pstep2" type="submit" class="btn btn-outline-primary">Register</button>
			</form>
			<!-- </div> -->
			<!-- </div> -->
		</div>
