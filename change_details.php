...
?>
<div class="container-fluid pt-3" style="background-color: #A8E0DA !important; color:#4E5269;">
	...
	<h3 class="text-center mt-3 mb-3"><b>Login And Security</b></h3>
	<div class="row">
		<div class="col-md-2">
    ...
    <span aria-hidden="true">&times;</span>
		...
		?>
			<form method="POST">
			<div class="rounded p-3 col-md-12 mb-2" style="background-color: #fff;">
			...
			<form method="POST">
					<div class="row">
						<div class="col-md-10">
							...
							<input type="password" class="form-control mb-2" id="exampleFormControlInput1" name="newpass1" placeholder="New Password" minlength="8" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
			...
			<div class="rounded p-3 col-md-12 mb-2" style="background-color: #fff;">
				...
				<form method="POST">
					<div class="row">
						<div class="col-md-10">
							<input type="email" class="form-control mb-2" id="exampleFormControlInput1" name="email" value="<?php echo $got_security['email_id']?>">
							<input type="text" class="form-control mb-2" id="exampleFormControlInput1" pattern="[0-9]{10}" maxlength="10" title="Enter valid number" name="mobile" value="<?php echo $got_security['contact_no']?>">
						</div>
						<div class="col-md-2 text-center">
