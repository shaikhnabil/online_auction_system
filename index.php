...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
	...
	<div class="carousel-inner" style="height:700px; margin:0;">
		<?php
		$cou = 1;
		while ($got_carousel_data = mysqli_fetch_assoc($checked_carousel_data)) { ?>
			<div class="carousel-item <?php if ($cou == 1) {
											echo 'active';
										} ?>">
...
<div class="row mt-1 mb-0 mx-0" style="background-color: #A8E0DA !important; color:#4E5269;">
	<div class="col-md-2 border py-5">
		<h3 class="text-center py-5"><b>Recently Added Auctions</b></h3>
	</div>
	<div class="col-md-10 border text-center">
		<div class="card-group p-4">
			<?php
